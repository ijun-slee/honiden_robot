...
namespace pcl
{
  ...
  /** \brief Grabber for OpenNI devices (i.e., Primesense PSDK, Microsoft Kinect, Asus XTion Pro/Live)
    ...
    * \ingroup io
    */
  class PCL_EXPORTS OpenNIGrabberOriginal : public Grabber
  {
    public:
      typedef boost::shared_ptr<OpenNIGrabberOriginal> Ptr;
      typedef boost::shared_ptr<const OpenNIGrabberOriginal> ConstPtr;
  ...
  OpenNIGrabberOriginal::getDevice () const
  {
    return device_;
  }
