...
namespace small_object_tracker
{
  ...
  public:
    ...
    ObjectDetector() :  min_y_(-0.5), max_y_(0.5),
			...
			cloudcb_rate(30.0), distance_threshold(0.3),
			...
			r_threshold(3) , g_threshold(3), b_threshold(3),
  ...
  private:
      ...
      if (n> number_threshold)
	{
	  ...
	  std::cout<<"current_object_point_number "<<(int)current_object.points.size() <<std::endl;
