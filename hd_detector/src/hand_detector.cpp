...
#include "../include/hand_detector.h"
#include "../include/pcl_tools/pcl_utils.h"
...
//#include <nnn/nnn.hpp>
#include "../include/pcl_tools/nnn/nnn.hpp"
//#include <pcl_tools/segfast.hpp>
#include "../include/pcl_tools/segfast.hpp"
...
public:
  ...
  void makeHand(pcl::PointCloud<pcl::PointXYZ> &cloud,Eigen::Vector4f &_arm,  body_msgs::Hand &handmsg){
    ...
    //この二つのクラスが全然ちがうため、同じstampでも合わなくなってしまっている   
    /*handmsg.stamp = ros::time
    　　//cloud.header.stamp = pcl::uint_t
こいつを何とか調整できる関数を作らねば。
    ...
    */
    ...
    /*
/opt/ros/hydro/include/ros/time.h:169:22: 備考:   第 1 引数を ‘uint64_t {aka long long unsigned int}’ から ‘const ros::Time&’ へ変換する方法が不明です
     */
    ...
    /*
/opt/ros/hydro/include/std_msgs/Header.h:55:8: 備考:   第 1 引数を ‘pcl::PCLHeader’ から ‘const std_msgs::Header_<std::allocator<void> >&’ へ変換する方法が不明です
    */
...
ros::Time ToRosTime(pcl::PointCloud<pcl::PointXYZ> &cloud){
  ros::Time totime;
totime.
